...
Usage:
    mojo run examples/mnist/train.mojo --epochs 10 --batch-size 32 --lr 0.01
...
fn parse_args() raises -> TrainConfig:
    ...
    parser.add_argument("weights-dir", "string", "mnist_weights")
...
fn compute_gradients(
    ...
    # FC2 (logits)
    var logits = linear(relu3_out, model.fc2_weights, model.fc2_bias)
    ...
    # FC2 backward
    var fc2_grads = linear_backward(grad_logits, relu3_out, model.fc2_weights)
