...
1. Test paper name parsing
1. Test paper directory resolution
...
1. Add `--paper <name>` option
1. Implement paper directory lookup
1. Filter tests to paper directory
...
1. Test argparse configuration
1. Test help text, defaults, validation
1. Verify tests pass
1. Close #780 and #781
...
1. Implement filtering in run_tests.sh (#811) - 2 hours
1. Integration and docs (#812) - 30 minutes
1. Cleanup and polish (#813) - 30 minutes
1. Close all 4 issues
...
1. ✅ Close verified complete issues (#782-783, #785-788)
1. **Start Priority 1**: Add CLI tests

### Short-term (Next Session)

1. Complete CLI tests (#780)
1. Close #780 and #781
1. Start paper filtering (#810-813)

### Final

1. Complete paper filtering
1. Close all remaining issues
1. All 44 issues complete! 🎉
