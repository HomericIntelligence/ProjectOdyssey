...
2. **Configuration & Templates** (`configs/`, `examples/`)
3. **Supporting Directories** (`benchmarks/`, `docs/`, `agents/`, `scripts/`, `tests/`)
4. **Development & Planning** (`notes/`, `worktrees/`)
...
2. **Key Contents** - Notable subdirectories or files
3. **When to Use** - Guidance for contributors
...
2. Explain purpose of `papers/` directory (ML paper implementations)
3. Explain purpose of `shared/` directory (reusable components)
4. Document supporting directories (`benchmarks/`, `docs/`, `agents/`, `scripts/`, `tests/`, etc.)
5. Describe how directories relate and work together (relationships section)
6. Add navigation guidance (where to find specific types of content)
