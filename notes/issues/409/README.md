...
2. **RandomVerticalFlip** - Mentioned in plan but not implemented
3. **Pipeline** type - Tests expect this name, only `Compose` exists
4. **Actual rotation** - RandomRotation returns original data
5. **2D image operations** - All transforms work on 1D flattened data
...
2. Line 279: "TODO: Implement proper 2D image resizing with interpolation"
3. Line 332: "TODO: Implement proper 2D center cropping for image tensors"
4. Line 387: "TODO: Implement proper 2D random cropping for image tensors"
5. Line 437: "TODO: For proper image flipping, need to reverse only width dimension"
6. Line 484: "TODO: Implement proper image rotation"
7. Missing: RandomErasing (no TODO, just completely absent)
8. Missing: RandomVerticalFlip (no TODO, just completely absent)
