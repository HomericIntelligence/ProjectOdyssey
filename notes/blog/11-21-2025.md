...
Epoch [ 1 / 1 ]
 #0 0x0000705108fbaf0b llvm::sys::PrintStackTrace(llvm::raw_ostream&, int)
    (/.pixi/envs/default/lib/libKGENCompilerRTShared.so+0x3baf0b)
 #1 0x0000705108fb8b36 llvm::sys::RunSignalHandlers()
    (/.pixi/envs/default/lib/libKGENCompilerRTShared.so+0x3b8b36)
 #2 0x0000705108fbbb17 SignalHandler(int, siginfo_t*, void*)
    (/.pixi/envs/default/lib/libKGENCompilerRTShared.so+0x3bbb17)
 ...
 #6 0x00005d6f44e8f2b1 train::train_epoch(model::LeNet5&,
    ...
    /examples/lenet-emnist/train.mojo:233:43
 #7 0x00005d6f44e8f2b1 train::main()
    /examples/lenet-emnist/train.mojo:341:37
...
#12 0x00005d6f44e8b2f5 _start (/train+0x12f5)
```
