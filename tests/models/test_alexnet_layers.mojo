...
fn main() raises:
    ...
    # # FIXME(float16 precision: test_conv1_forward_float16 disabled - float16 precision insufficient
    ...
    print("  test_conv1_forward_float16... # FIXME(float16 precision")
    ...
    # # FIXME(float16 precision: test_conv2_forward_float16 disabled - float16 precision insufficient
    # for 5x5 kernel with 64 input channels (1600 multiplications per output element).
    # See: https://github.com/mvillmow/ProjectOdyssey/issues/2701
    print("  test_conv2_forward_float16... # FIXME(float16 precision")
    ...
    # # FIXME(float16 precision: test_conv3_forward_float16 disabled - float16 precision insufficient
    # for 3x3 kernel with 192 input channels (1728 multiplications per output element).
    # See: https://github.com/mvillmow/ProjectOdyssey/issues/2701
    print("  test_conv3_forward_float16... # FIXME(float16 precision")
