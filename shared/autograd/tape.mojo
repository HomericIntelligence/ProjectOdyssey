...
struct GradientTape:
    ...
    # ========================================================================
    # Backward Pass Implementations (Index-based helpers)
    # ========================================================================
    # These methods implement the chain rule for each operation type.
    # They are called by the backward() dispatch loop.
